...
<body>
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="slider_info">
                            ...
                            <a href="#upload" class="boxed_btn">Login Now</a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6">
                        <div class="illastrator_png">
                            <img src="img/banner/contribute_resources.svg" alt="contribute resources covid-19 relief">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form action="user.php" method="POST" >
							<div class="mt-10">
								<input type="email" name="email" placeholder="Emali"
									onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email'"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" title="Must contain @ and at least 2 or more characters like .co, .in, .com, etc." required
									class="single-input">
							</div>
                            <div class="mt-10">
								<input type="password" name="pass" placeholder="Password"
									onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"  required
									class="single-input">
							</div>
                  ...
                  <br>
                            <div class="mt-10">
                                <button type="submit" name="post" class="boxed_btn">Login</button>
							</div>
            </form> 
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="single_about_info">
                        <h3>Over 16M Total Cases in India</h3>
                        <p>We are a group of youngsters who just want that no one looses their closed ones just because of not access to some resources which someone else is having and you just can't find it.
                        <br>    We are here to provide you with all we can. We try our best so that no one out their runs out of resources. </p>
                        <a href="join-us.php" class="boxed_btn">Join-Us</a>
                    </div>
                </div>
    ...
    <!-- WHO -->
    <div style="background-color: #181818;"  class="about_area">
        <div class="container">
            <div class="row">
                <div class="col-xl-10 offset-xl-1 col-lg-10">
                    <!-- <script src="https://apps.elfsight.com/p/platform.js" defer></script>
                    <div class="elfsight-app-69c7290c-0471-46b6-b53a-542f83254f60"></div> -->
                </div>
            </div>
        </div>
    </div>
