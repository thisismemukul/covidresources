                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="slider_info">
                            <h3>Contribute Resources<br>
                            Medical Supplies,<br>
                            Oxygen ,Plasma</h3>
                            <!-- <a href="search_resources.php" class="boxed_btn">Search Resources</a> -->
                            <a href="contribute_resources.html" class="boxed_btn">Contribute Now</a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6">
  ...
  <div class="row py-5">
        ...
        <div class="card-body bg-white rounded">
          <div class="table-responsive">
            <table id="example" style="width:100%" class="table table-striped table-bordered">
              ...
              <tbody>
                        <?php 
        $results = mysqli_query($con,"SELECT * FROM resources WHERE aproved ='N' ORDER BY ID DESC") or die("failed to query database".mysqli_error());
    ...
    ?>
                            <tr> 
                                ...
                                <td colspan="2" scope="colgroup"><?php echo ($rows['phone']);  ?></td>
                                ...
                                <input type="hidden" name="ID" value="<?php echo $ID;  $_SESSION['ID']=$ID; ?>">
                                <td><button type="submit" name="correct" ><a style="border-radius: 8px;  padding: 0px 5px;" class="boxed_btn"><i class="fa fa-check-circle"></i></a></button></td>
                                <td><button type="submit" name="wrong" ><a style="border-radius: 8px;  padding: 0px 5px; background: #f44a40;" href="#" class="boxed_btn"><i class="fa fa-trash"></i></a></button></td>
                                </form>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="single_about_info">
                        ...
                        <a href="logout.php" class="boxed_btn">Logout</a>
                    </div>
                </div>
